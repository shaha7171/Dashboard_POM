...
public class StylesPageTest extends BaseTest{
	...
	@Test(priority = 1)
	public void ValidateStylesPageTestnTable() {
		TMBar.ClickOnStyles();
		String Title = Style.validateStylesPageTitle();
		Assert.assertEquals(Title, "UC Dashboard Manager - Admin");
		Assert.assertTrue(isElementPresent("StylesTable_CSS"), "Table is not present");
	}
